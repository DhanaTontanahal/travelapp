  ...
  controllers.controller('AuthenticationLoginCtrl', ['$filter', '$timeout', 'AuthService', '$rootScope', '$scope', '$window', '$location', function ($filter, $timeout, AuthService, $rootScope, $scope, $window, $location) {
    ...
    $scope.submitOfferRide = function () {
      ...
      alert("Ride submitted successfully...");
        ...
        $scope.offerRide.nameOfTraveller= "";
        $scope.offerRide.numOfSeats= "";
        $scope.offerRide.contactNum= "";
        $scope.offerRide.vehicleMake= "";
        $scope.offerRide.vehicleRegNum= "";
    }
    ...
    $scope.submitFindRide = function () {
      ...
      $scope.findRide=""
      $scope.findRide.travelDate= "";
      $scope.findRide.travelTime= "";
      $scope.findRide.fromLoc= "";
      $scope.findRide.toLoc="";
      $scope.findRide.nameOfTraveller1= "";
      $scope.findRide.contactNum1="";
  
      $scope.findRide.nameOfTraveller2= "";
      $scope.findRide.contactNum2="";
  
      $scope.findRide.nameOfTraveller3= "";
      $scope.findRide.contactNum3="";
