...
function dragElement(elmnt) {
  ...
  function closeDragElement() {
    ...
    document.onmousemove = null;
      ...
      $scope.namesOfActivity = ["Morning","Evening", "Select"];
      ...
      $scope.columns1 = [
        { name: 'Owner Name', visible: true, width: 200, headerCellClass: 'blue', field: 'nameSatsangi', enableFiltering: true },
        { name: 'Car No', visible: true, headerCellClass: 'blue', field: 'branchCode', enableFiltering: true },
